...
.method static applyChainConstraints(Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;Landroid/support/constraint/solver/LinearSystem;IILandroid/support/constraint/solver/widgets/ChainHead;)V
    ...
    .local v38, "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    ...
    .local v40, "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 217
    .end local v38    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .end local v39    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v40    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .end local v6    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .end local v7    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v38    # "listMatchConstraints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/constraint/solver/widgets/ConstraintWidget;>;"
    .restart local v39    # "widget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v40    # "previousMatchConstraintsWidget":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .local v25, "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .end local v25    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .local v3, "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :cond_1c
    move-object/from16 v25, v3
    ...
    .line 236
    .end local v3    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    .restart local v25    # "lastMatch":Landroid/support/constraint/solver/widgets/ConstraintWidget;
    :goto_15
    move-object v3, v0
    ...
    .end local v1    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .local v24, "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .line 368
    .end local v24    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .end local v1    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .restart local v24    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    iget-object v1, v8, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mListAnchors:[Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .end local v2    # "beginNext":Landroid/support/constraint/solver/SolverVariable;
    .end local v3    # "beginNextTarget":Landroid/support/constraint/solver/SolverVariable;
    .local v28, "beginNextTarget":Landroid/support/constraint/solver/SolverVariable;
    ...
    .end local v24    # "beginNextAnchor":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .end local v28    # "beginNextTarget":Landroid/support/constraint/solver/SolverVariable;
    .end local v29    # "beginNext":Landroid/support/constraint/solver/SolverVariable;
    ...
    .local v24, "beginTarget":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    move/from16 v9, v28
    ...
    .line 406
    .end local v24    # "beginTarget":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    .end local v8    # "end":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .end local v9    # "beginTarget":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    .restart local v24    # "beginTarget":Landroid/support/constraint/solver/widgets/ConstraintAnchor;
