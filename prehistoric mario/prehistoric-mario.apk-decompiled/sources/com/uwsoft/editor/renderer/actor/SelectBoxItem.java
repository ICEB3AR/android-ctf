...
public class SelectBoxItem<T> extends SelectBox<T> implements IBaseItem {
    ...
    public SelectBoxItem(SelectBoxVO selectBoxVO, Essentials essentials2, CompositeItem compositeItem) {
        this(selectBoxVO, essentials2);
        setParentItem(compositeItem);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SelectBoxItem(SelectBoxVO selectBoxVO, Essentials essentials2) {
        super(essentials2.rm.getSkin(), selectBoxVO.style.isEmpty() ? "default" : selectBoxVO.style);
        this.mulX = 1.0f;
        this.mulY = 1.0f;
        this.layerIndex = 0;
    ...
    public void setStyle(SelectBox.SelectBoxStyle selectBoxStyle, String str) {
