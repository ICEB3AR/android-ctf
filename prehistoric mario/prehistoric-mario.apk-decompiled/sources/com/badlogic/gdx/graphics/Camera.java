...
public abstract class Camera {
    ...
    public Vector3 unproject(Vector3 vector3, float f, float f2, float f3, float f4) {
        ...
        vector3.y = (((((((float) Gdx.graphics.getHeight()) - f6) - 1.0f) - f2) * 2.0f) / f4) - 1.0f;
    ...
    public Vector3 unproject(Vector3 vector3) {
        unproject(vector3, 0.0f, 0.0f, (float) Gdx.graphics.getWidth(), (float) Gdx.graphics.getHeight());
        return vector3;
    }

    public Vector3 project(Vector3 vector3) {
        project(vector3, 0.0f, 0.0f, (float) Gdx.graphics.getWidth(), (float) Gdx.graphics.getHeight());
        return vector3;
    }
    ...
    public Ray getPickRay(float f, float f2) {
        return getPickRay(f, f2, 0.0f, 0.0f, (float) Gdx.graphics.getWidth(), (float) Gdx.graphics.getHeight());
    }
}
