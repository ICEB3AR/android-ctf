        ...
        public void setOffsetFromFile(RandomAccessFile randomAccessFile, ByteBuffer byteBuffer) throws IOException {
            ...
            try {
                ...
                if (byteBuffer.getInt(0) == ZipResourceFile.kLFHSignature) {
                    this.mOffset = j + 30 + ((long) (byteBuffer.getShort(26) & ZipResourceFile.kMaxCommentLen)) + ((long) (byteBuffer.getShort(28) & ZipResourceFile.kMaxCommentLen));
                    return;
                }
        ...
        if (length >= 22) {
            ...
            if (read4LE == kEOCDSignature) {
                ...
                if (j3 + j2 > length) {
                    ...
                    short s2 = 65535;
                    byte[] bArr = new byte[kMaxCommentLen];
                    ...
                    while (i2 < s) {
                        if (map.getInt(i3) == kCDESignature) {
                            ...
                            zipEntryRO.mMethod = map.getShort(i3 + 10) & kMaxCommentLen;
