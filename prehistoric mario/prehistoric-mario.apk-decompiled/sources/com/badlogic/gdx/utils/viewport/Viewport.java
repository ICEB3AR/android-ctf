...
public abstract class Viewport {
    ...
    public Vector3 unproject(Vector3 vector3) {
        this.camera.unproject(vector3, (float) this.screenX, (float) this.screenY, (float) this.screenWidth, (float) this.screenHeight);
        return vector3;
    }

    public Vector3 project(Vector3 vector3) {
        this.camera.project(vector3, (float) this.screenX, (float) this.screenY, (float) this.screenWidth, (float) this.screenHeight);
        return vector3;
    }

    public Ray getPickRay(float f, float f2) {
        return this.camera.getPickRay(f, f2, (float) this.screenX, (float) this.screenY, (float) this.screenWidth, (float) this.screenHeight);
    }

    public void calculateScissors(Matrix4 matrix4, Rectangle rectangle, Rectangle rectangle2) {
        ScissorStack.calculateScissors(this.camera, (float) this.screenX, (float) this.screenY, (float) this.screenWidth, (float) this.screenHeight, matrix4, rectangle, rectangle2);
    }
