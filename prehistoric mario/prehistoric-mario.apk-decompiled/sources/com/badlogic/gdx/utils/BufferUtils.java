...
public final class BufferUtils {
    ...
    public static void copy(short[] sArr, int i, Buffer buffer, int i2) {
        int i3 = i2 << 1;
        buffer.limit(buffer.position() + bytesToElements(buffer, i3));
