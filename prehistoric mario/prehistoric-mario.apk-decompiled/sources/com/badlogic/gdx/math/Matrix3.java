...
public class Matrix3 implements Serializable {
    ...
    public Matrix3 setToRotation(Vector3 vector3, float f, float f2) {
        float[] fArr = this.val;
        float f3 = 1.0f - f;
        fArr[0] = (vector3.x * f3 * vector3.x) + f;
        fArr[1] = ((vector3.x * f3) * vector3.y) - (vector3.z * f2);
        fArr[2] = (vector3.z * f3 * vector3.x) + (vector3.y * f2);
        fArr[3] = (vector3.x * f3 * vector3.y) + (vector3.z * f2);
        fArr[4] = (vector3.y * f3 * vector3.y) + f;
        fArr[5] = ((vector3.y * f3) * vector3.z) - (vector3.x * f2);
        fArr[6] = ((vector3.z * f3) * vector3.x) - (vector3.y * f2);
        fArr[7] = (vector3.y * f3 * vector3.z) + (vector3.x * f2);
    ...
    public Vector2 getScale(Vector2 vector2) {
        float[] fArr = this.val;
        vector2.x = (float) Math.sqrt((double) ((fArr[0] * fArr[0]) + (fArr[3] * fArr[3])));
        vector2.y = (float) Math.sqrt((double) ((fArr[1] * fArr[1]) + (fArr[4] * fArr[4])));
        return vector2;
    }
